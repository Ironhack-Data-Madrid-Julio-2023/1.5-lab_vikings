...
text = ['\nWelcome to the Final Battle of All Times!!!! In the following minutes, a combat will start in which you will fight for your survival. \
    ...
    'VIKINGS are proud and dangerous warriors known for their strength and perseverance. Whenever a viking army is left with less than ten soldiers, \
    ...
    "Your people have proven themselves the champions of the Greatest War of All Times, winning both battles fought.\
    ...
    "You lost both battles. The fields are red with the blood of your soldiers, and your body is a mesh of bones, wounds and pain. \
    \nAs you close your eyes and fall to the ground, a goat approaches and starts eating your hair.\
    \n\nHELL AWAITS YOU, AND YOUR FURIOUS DEFEATED WARRIORS TOO..\
    \n\nGAME OVER\n"]
